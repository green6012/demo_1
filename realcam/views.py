...
#     response['Content-Disposition'] = 'attachment; filename=Warning' + '.xlsx'
#     wb = xlwt.Workbook(encoding = 'utf-8')
#     ws = wb.add_sheet('Warning')
#     row_num = 0
#     font_style = xlwt.XFStyle()
#     font_style.font.bold = True
#     colums = ['Email Address', 'Date', 'Location']
#     for col_num in range(len(colums)):
#         ws.write(row_num, col_num, colums[col_num], font_style)
#     font_style = xlwt.XFStyle()
#
#     rows = Warning.objects.filter(user = request.user,).values_list(
#         'user', 'time', 'location'
#     )
#     for row in rows:
#         row_num +=1
